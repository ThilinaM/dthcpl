...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.users.update", [$user->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="slag">{{ trans('cruds.user.fields.slag') }}</label>
                <input class="form-control {{ $errors->has('slag') ? 'is-invalid' : '' }}" type="text" name="slag" id="slag" value="{{ old('slag', $user->slag) }}">
                @if($errors->has('slag'))
                    <div class="invalid-feedback">
                        {{ $errors->first('slag') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.user.fields.slag_helper') }}</span>
            </div>
            <div class="form-group">
