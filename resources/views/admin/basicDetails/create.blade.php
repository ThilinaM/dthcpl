...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.basicDetail.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.basic-details.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('sms_serviceon') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="sms_serviceon" id="sms_serviceon" value="1" {{ old('sms_serviceon', 0) == 1 ? 'checked' : '' }}>
