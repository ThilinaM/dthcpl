                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    @endcan
                                    @can('basic_detail_access')
                                        <a class="dropdown-item" href="{{ route('frontend.basic-details.index') }}">
                                            {{ trans('cruds.basicDetail.title') }}
                                        </a>
                                    @endcan
                                    ...
                                    @can('user_detail_access')
                                        <a class="dropdown-item" href="{{ route('frontend.user-details.index') }}">
