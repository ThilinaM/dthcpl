                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.user-details.update", [$userDetail->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $userDetail->name) }}" required>
                            @if($errors->has('name'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="nic" id="nic" value="{{ old('nic', $userDetail->nic) }}">
                            @if($errors->has('nic'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('nic') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="library_card_no" id="library_card_no" value="{{ old('library_card_no', $userDetail->library_card_no) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="mobile" id="mobile" value="{{ old('mobile', $userDetail->mobile) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="address" id="address" value="{{ old('address', $userDetail->address) }}">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="sms_send" id="sms_send" value="1" {{ $userDetail->sms_send || old('sms_send', 0) === 1 ? 'checked' : '' }}>
                                <label for="sms_send">{{ trans('cruds.userDetail.fields.sms_send') }}</label>
                            </div>
