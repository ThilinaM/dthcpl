...
class UserDetailsController extends Controller
{
    public function index()
    {
        ...
        $userDetails = UserDetail::with(['created_by'])->get();

        return view('frontend.userDetails.index', compact('userDetails'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.userDetails.create');
    }
    ...
    public function edit(UserDetail $userDetail)
    {
        ...
        return view('frontend.userDetails.edit', compact('userDetail'));
    }
