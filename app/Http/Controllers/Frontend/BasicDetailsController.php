...
class BasicDetailsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.basicDetails.index', compact('basicDetails'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.basicDetails.create');
    }
    ...
    public function store(StoreBasicDetailRequest $request)
    {
        ...
        return redirect()->route('frontend.basic-details.index');
    }
    ...
    public function edit(BasicDetail $basicDetail)
    {
        ...
        return view('frontend.basicDetails.edit', compact('basicDetail'));
    }
    ...
    public function show(BasicDetail $basicDetail)
    {
        ...
        return view('frontend.basicDetails.show', compact('basicDetail'));
    }
